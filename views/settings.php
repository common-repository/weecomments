...
<div id="weecomments_back">
    ...
    <div id="wee_logo_container">
        ...
        <p>
            ...
            <input type="submit" name="submitConfiguration" value="<?php _e('send', 'weecomments')?>" class="wee_button wee_button_small" />
            </form>
        </p>
        ...
        <h4><?php _e('Now you can configure your settings in', 'weecomments')?> <a class="green" target="_blank" href="http://weecomments.com/en/">weecomments.com</a></h4>
    </div>
